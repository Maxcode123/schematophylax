...
export type StorageHash =
  StorageHashBase<'7b15cb89e685f6b5d8e3f79fdf8ae1d91c5b3b1051f90e9db4460d9d7b6db098'>;
export type ExecutionHash =
  ExecutionHashBase<'e12529424ca0f024ade3dfe2a9925588787c29018017c1f7a8b76437c6796f44'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Migration: {
      readonly id: Char<36>;
      readonly userGroupId: Char<36>;
      readonly postgresConnectionId: Char<36>;
      readonly createByUserId: Char<36>;
    ...
    readonly MigrationLog: {
      readonly id: Char<36>;
      readonly userGroupId: Char<36>;
      readonly migrationId: Char<36>;
      readonly log: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly PostgresConnection: {
      readonly id: Char<36>;
      readonly userGroupId: Char<36>;
      readonly name: CodecTypes['pg/text@1']['output'];
      readonly encrypted_conn_str: CodecTypes['pg/text@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly User: {
...
export type FieldInputTypes = {
  readonly public: {
    readonly Migration: {
      ...
      readonly userGroupId: CodecTypes['sql/char@1']['input'];
      readonly postgresConnectionId: CodecTypes['sql/char@1']['input'];
      readonly createByUserId: CodecTypes['sql/char@1']['input'];
    ...
    readonly MigrationLog: {
      readonly id: CodecTypes['sql/char@1']['input'];
      readonly userGroupId: CodecTypes['sql/char@1']['input'];
      readonly migrationId: CodecTypes['sql/char@1']['input'];
      readonly log: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly PostgresConnection: {
      ...
      readonly encrypted_conn_str: CodecTypes['pg/text@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly User: {
...
export namespace Models {
  ...
  export type public_User = {
    ...
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    userGroup: public_UserGroup;
    readonly [RelationKeys]?: 'userGroup';
  };
  export type public_PostgresConnection = {
    id: Char<36>;
    userGroupId: Char<36>;
    name: CodecTypes['pg/text@1']['output'];
    encrypted_conn_str: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    userGroup: public_UserGroup;
    readonly [RelationKeys]?: 'userGroup';
  };
  export type public_Migration = {
    id: Char<36>;
    userGroupId: Char<36>;
    postgresConnectionId: Char<36>;
    createByUserId: Char<36>;
    status: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    userGroup: public_UserGroup;
    postgresConnection: public_PostgresConnection;
    createdBy: public_User;
    readonly [RelationKeys]?: 'userGroup' | 'postgresConnection' | 'createdBy';
  };
  export type public_MigrationLog = {
    id: Char<36>;
    userGroupId: Char<36>;
    migrationId: Char<36>;
    log: CodecTypes['pg/text@1']['output'];
    createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    userGroup: public_UserGroup;
    migration: public_Migration;
    readonly [RelationKeys]?: 'userGroup' | 'migration';
  };
}
...
export declare const models: {
  public: {
    ...
    PostgresConnection: Models.public_PostgresConnection;
    Migration: Models.public_Migration;
    MigrationLog: Models.public_MigrationLog;
  };
};
          ...
          readonly table: {
            readonly Migration: {
              columns: {
                ...
                readonly postgresConnectionId: {
                  readonly nativeType: 'character';
                  readonly codecId: 'sql/char@1';
                  readonly nullable: false;
                  readonly typeParams: { readonly length: 36 };
                };
                readonly createByUserId: {
                  readonly nativeType: 'character';
                  readonly codecId: 'sql/char@1';
                  readonly nullable: false;
                  readonly typeParams: { readonly length: 36 };
              ...
              indexes: readonly [
                {
                  readonly name: 'Migration_userGroupId_idx_716dac96';
                  readonly prefix: 'Migration_userGroupId_idx';
                  readonly columns: readonly ['userGroupId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Migration_postgresConnectionId_idx_7cf3a2d5';
                  readonly prefix: 'Migration_postgresConnectionId_idx';
                  readonly columns: readonly ['postgresConnectionId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Migration_createByUserId_idx_8088771c';
                  readonly prefix: 'Migration_createByUserId_idx';
                  readonly columns: readonly ['createByUserId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                ...
                },
                {
                  ...
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'PostgresConnection';
                    readonly columns: readonly ['id'];
                  };
                },
                {
            ...
            readonly MigrationLog: {
              ...
              indexes: readonly [
                {
                  readonly name: 'MigrationLog_userGroupId_idx_716dac96';
                  readonly prefix: 'MigrationLog_userGroupId_idx';
                  readonly columns: readonly ['userGroupId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'MigrationLog_migrationId_idx_e76b2003';
                  readonly prefix: 'MigrationLog_migrationId_idx';
                  readonly columns: readonly ['migrationId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'MigrationLog';
                    readonly columns: readonly ['userGroupId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly PostgresConnection: {
              ...
              indexes: readonly [
                {
                  readonly name: 'PostgresConnection_userGroupId_idx_716dac96';
                  readonly prefix: 'PostgresConnection_userGroupId_idx';
                  readonly columns: readonly ['userGroupId'];
                  readonly unique: false;
                },
              ];
            ...
            readonly User: {
              ...
              indexes: readonly [
                {
                  readonly name: 'User_userGroupId_idx_716dac96';
                  readonly prefix: 'User_userGroupId_idx';
                  readonly columns: readonly ['userGroupId'];
                  readonly unique: false;
                },
              ];
...
> & {
  ...
  readonly roots: {
    ...
    readonly PostgresConnection: {
      ...
      readonly model: 'PostgresConnection';
    };
    readonly Migration: { readonly namespace: 'public' & NamespaceId; readonly model: 'Migration' };
    readonly MigrationLog: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'MigrationLog';
    };
  };
  readonly domain: {
    readonly namespaces: {
      readonly public: {
        readonly models: {
          readonly Migration: {
            ...
            readonly relations: {
              readonly userGroup: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['userGroupId'];
              ...
              readonly postgresConnection: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['postgresConnectionId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly createdBy: {
                ...
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['createByUserId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'Migration';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userGroupId: { readonly column: 'userGroupId' };
                readonly postgresConnectionId: { readonly column: 'postgresConnectionId' };
                readonly createByUserId: { readonly column: 'createByUserId' };
          ...
          readonly MigrationLog: {
            ...
            readonly relations: {
              ...
              readonly migration: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'Migration';
                };
                readonly cardinality: 'N:1';
                readonly nullable: false;
                readonly on: {
                  readonly localFields: readonly ['migrationId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'MigrationLog';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userGroupId: { readonly column: 'userGroupId' };
                readonly migrationId: { readonly column: 'migrationId' };
                readonly log: { readonly column: 'log' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly PostgresConnection: {
            ...
            readonly storage: {
              readonly table: 'PostgresConnection';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userGroupId: { readonly column: 'userGroupId' };
                readonly name: { readonly column: 'name' };
                readonly encrypted_conn_str: { readonly column: 'encrypted_conn_str' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
            ...
            readonly relations: {
              readonly users: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['userGroupId'];
                };
              };
            };
            readonly storage: {
